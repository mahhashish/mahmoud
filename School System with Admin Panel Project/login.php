...
if(isset($_POST['submit']))
{
 ...
 $password = md5($_POST['password']);
   ...
   $sql_slct = mysql_query("select * from user_registration where email='$email' and password= '$password'");

if(mysql_num_rows($sql_slct)>0)
   {  
...
<body>
  <div class="login">
    ...
    <div  style="color: red; "><?php echo $msg;?></div>
        ...
        <p style="font-family: sans-serif; text-align: center; padding-bottom: 10px; padding-top: 30px" >Not Registered?  
