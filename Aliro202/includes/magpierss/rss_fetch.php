        ...
        if (isset($resp) and $resp) {
          if ($resp->status == '304' ) {
            ...
            elseif ( is_success( $resp->status ) ) {
                ...
                elseif ( $resp->error ) {
                    # compensate for Archie's annoying habbit to tacking
                    # on '\n'
...
/*=======================================================================*\
    ...
    Output:     an HTTP response object (see ArchieHTTP.php)
\*=======================================================================*/
function _fetch_remote_file ($url, $headers = "" ) {
    // ArchieHTTP is an HTTP client in PHP
    $client = new ArchieHTTP();
...
/*=======================================================================*\
    ...
    Input:      an HTTP response object (see ArchieHTTP)
...
// NOTE: the following code should really be in ArchieHTTP, or at least
