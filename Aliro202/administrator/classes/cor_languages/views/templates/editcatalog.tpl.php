...
$this->addCSS(_ALIRO_ADMIN_DIR.'/classes/cor_languages/views/css/translate.css');
...
<script type="text/javascript" src="<?php echo $this->getCfg('admin_site');?>/classes/cor_languages/prototype.js"></script>
