	...
	function startEditHeader ($title) {
		...
		<form method="post" id="adminForm" name="adminForm" action="index.php">
   		...
   		<tr>
			...
			<div class="title">
			<!--
			<img src="<?php echo aliroCore::getInstance()->getCfg('admin_site').'/images/asterisk.png'; ?>" alt="<?php echo $title; ?>" />
			-->
			<span class="sectionname">&nbsp;<?php echo T_('Aliro '); echo $title; ?></span>
			</div>
			</td>
    	</tr>
		<?php
...
class listFoldersHTML extends foldersAdminHTML {
	...
	function listLine ($folder, $descendants, $i, $k, $n, $basicurl) {
		...
		?>
				<tr class="<?php echo "row$k"; ?>">
					...
					<td width="7%" align="center"><img src="<?php echo aliroCore::getInstance()->getCfg('admin_site'); ?>/images/publish_g.png" border="0" alt="Published" />
					</td>
					<?php } else { ?>
					<td width="7%" align="center"><img src="<?php echo aliroCore::getInstance()->getCfg('admin_site'); ?>/images/publish_x.png" border="0" alt="Published" />
					</td>
					<?php } ?>
				</tr>
		<?php
	...
	function view (&$folders, $descendants, $basicurl, $search='')  {
		$this->formStart(T_('Folders'), aliroCore::getInstance()->getCfg('admin_site').'/images/asterisk.png');
		$this->blankRow();
