...
Dec/09/2009 by Martin Brampton to incorporate into Aliro
============================================================================================
*/

// Internal program-specific Debug option.
define ("DEBUG", aliroCore::getInstance()->getCfg('debug'));
...
class xml2json {
	...
	=============================================================================
	*/	
	public function transformXmlStringToJson($xmlStringContents) {
		/*
		...
		*/
		/* Modified by Martin Brampton to split XML loading so that operation on
		 * a Simple XML object is possible with additional method.
		 */
		$simpleXmlElementObject = simplexml_load_string($xmlStringContents);
		
		return $this->convertSimpleXmlElementObjectIntoArray($simpleXmlElementObject);
	}

	public function transformXmlObjectToJson($simpleXmlObject) {
		...
		$array1 = $this->convertSimpleXmlElementObjectIntoArray($simpleXmlElementObject);
		...
		if (get_class($simpleXmlElementObject) == SIMPLE_XML_ELEMENT_PHP_CLASS) {
   		...
   		if (is_array($simpleXmlElementObject)) {
       		...
       		foreach($simpleXmlElementObject as $key=>$value) {
				...
				$recursionDepth++;	       			
           		$resultArray[$key] = $this->convertSimpleXmlElementObjectIntoArray($value, $recursionDepth);
