...
Aliro version: Changed to PHP5, made UTF-8 default encoding
	Martin Brampton 16 June 2009
...
abstract class FeedCreator extends HtmlDescribable {
	...
	*/
	 ...
	 * @since 1.6.1 ISO-8859-1
	 * Changed for Aliro to UTF-8
	 **/
	 ...
	 * @access private
	 *
	 * Customised for Aliro, using different technique to derive file name
	 */
	protected function _generateFilename() {
		return _ALIRO_SITE_BASE.'/cache/rssfeeds/'.$this->identifier.'.'.$this->suffix;
	}
