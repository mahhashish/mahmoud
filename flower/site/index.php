...
<link href="site/css/linecons.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="site/js/jquery-scrolltofixed.js"></script>
...
<script type="text/javascript" src="site/js/wow.js"></script>
<script type="text/javascript" src="site/js/classie.js"></script>

<!--[if lt IE 9]>
    <script src="site/js/respond-1.1.0.min.js"></script>
    <script src="site/js/html5shiv.js"></script>
    <script src="site/js/html5element.js"></script>
<![endif]-->
...
<header id="header_outer">
  <div class="container">
    <div class="header_section">
      <div class="logo"><a href="javascript:void(0)"><img src="site/img/logob.png" alt=""></a></div>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont flipInY wow animated">
              <h3><?php echo $siteInfo['title'];?></h3>
              <h2><?php echo $siteInfo['header'];?></h2>
...
<div class="top_cont_latest">
  ...
  <!--<div class="work_pic"><img src="site/img/dashboard_pic.png" alt=""></div>-->
  </div>
</section>
<!--main-section-end--> 
  ...
  <div class="portfolio"> 
    ...
    <div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap"> 
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   videography isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic1.jpg"  alt="Portfolio 1"> </div>
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic2.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic3.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  photography  branding web isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic4.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic5.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic6.jpg" alt="Portfolio 1"> </div>
        <div class="project-overlay">
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic7.jpg" alt="Portfolio 1"> </div>
      ...
      <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   photography isotope-item">
        <div class="portfolio-image"> <img src="site/img/portfolio_pic8.jpg" alt="Portfolio 1"> </div>
  ...
  <div class="client_area ">
    <div class="client_section animated  fadeInUp wow">
      <div class="client_profile">
        <div class="client_profile_pic"><img src="site/img/client-pic1.jpg" alt=""></div>
        <h3>Saul Goodman</h3>
        <span>Lawless Inc</span> </div>
      <div class="quote_section">
        <div class="quote_arrow"></div>
        <p><b><img src="site/img/quote_sign_left.png" alt=""></b> Proin iaculis purus consequat sem cure  digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper. <small><img src="site/img/quote_sign_right.png" alt=""></small> </p>
      </div>
      <div class="clear"></div>
    </div>
    <div class="client_section animated  fadeInDown wow">
      <div class="client_profile flt">
        <div class="client_profile_pic"><img src="site/img/client-pic2.jpg" alt=""></div>
...
<div class="c-logo-part"><!--c-logo-part-start-->
  <div class="container">
    <ul class="delay-06s animated  bounce wow">
      <li><a href="javascript:void(0)"><img src="site/img/c-liogo1.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="site/img/c-liogo2.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="site/img/c-liogo3.png" alt=""></a></li>
      <li><a href="javascript:void(0)"><img src="site/img/c-liogo5.png" alt=""></a></li>
    </ul>
  </div>
</div>
<!--c-logo-part-end-->
    ...
    <div class="team-leader-block clearfix">
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-03s">
          ...
          <img src="site/img/team-leader-pic1.jpg" alt="">
          <ul>
      ...
      <div class="team-leader-box">
        <div class="team-leader  wow fadeInDown delay-06s">
          <div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
          <img src="site/img/team-leader-pic2.jpg" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
      ...
      <div class="team-leader-box">
        <div class="team-leader wow fadeInDown delay-09s">
          <div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
          <img src="site/img/team-leader-pic3.jpg" alt="">
          <ul>
            <li><a href="javascript:void(0)" class="fa-twitter"></a></li>
            <li><a href="javascript:void(0)" class="fa-facebook"></a></li>
            <li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
