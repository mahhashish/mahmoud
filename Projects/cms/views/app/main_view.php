	...
	<body>
		...
		<div class="container">
			...
			<div class="form-group">
                ...
                $data = array('class' => 'form-control', 'name' => 'title', 'placeholder' => 'Enter Title', 'value' => set_value('title'));
			...
			<div class="form-group">
                ...
                $data = array('class' => 'form-control', 'name' => 'header', 'placeholder' => 'Enter Header', 'value' => set_value('header'));
                echo form_input($data);
				?>
			</div>
