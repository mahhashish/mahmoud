...
* @package Aliro
* @copyright (C) 2007 Martin Brampton, from code (c) Miro International Pty Ltd
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
* Aliro is Free Software
*/

// Son of Suckerfish JS for IE
sfHover = function() {
...
function selectAlert (message,item,prefix) {
	if (document.adminForm.boxchecked.value == 0)
        { alert(message);}
        else{var fun=prefix+'submitbutton';fun(item)}
}
/**
