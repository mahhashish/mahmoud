...
class aliroLanguageExtended extends aliroLanguageBasic {
	...
	public function export () {
        ...
        $zipfile = $zipbase.'/media/'.$filename;
	...
	private static function loadLocales () {
		...
		$file = criticalInfo::getInstance()->class_base.'/language/locales.xml';
    ...
    public function getLanguages() {
    	$path = criticalInfo::getInstance()->absolute_path.'/language/';
	...
	public static function oldGetLocales() {
        $xmlfile = criticalInfo::getInstance()->absolute_path.'/language/locales.xml';
        $p = xml_parser_create();
