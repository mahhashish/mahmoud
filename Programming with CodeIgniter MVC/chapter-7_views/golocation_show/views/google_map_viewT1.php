...
var url_to_call_controller_method_to_show = '<?php echo base_url(); ?>index.php/gmaps/user_location/' + latitude + '/' + longitude; 
  
$(location).attr('href', url_to_call_controller_method_to_show );
}
...
$(document).ready(function() {
	...
	function getLocation(position) { 
	   ...
	   setTimeout ( show_user_on_map, 2000); // delay 2 sec. before showing on the map   
