...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //This part is more jQuery Related
        //In short, we make an AJAX post request and get the response back from server
        $('input[type="submit"]').click(function(e){
            ...
            $.post('/subscribers/submit', {
                ...
                if($data=='1') {
                    ...
                    //This part will echo our form validation errors 
                    $('div.content')
                        .hide()
                        .removeClass('success error')
                        .addClass('error')
