...
class contacts extends dispatcher {
    ...
    function main(){
        ...
        if (count($contacts)){
            ...
            foreach ($contacts as $contact){
                ...
                $delete_url      = $this->url('delete_preview',$cgi_vars);
	...
	function delete_preview(){
		...
		$cgi_var = array('cid'=>$cid);
		$yes_url = $this->url('delete_contact',$cgi_var);
		$no_url = $this->url('main');

		echo "<h1>Are you Sure?</h1>\n";

		echo '<a href="' , $yes_url , '">Yes</a>';

		echo '&nbsp;&nbsp;&nbsp;&nbsp;'; # space 
		
		echo '<a href="', $no_url , '">No</a>';
	}
