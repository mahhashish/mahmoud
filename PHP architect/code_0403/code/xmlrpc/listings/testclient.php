...
$g_oClient = new UpdateServiceClient("http://192.168.0.192/xmlrpc/");
...
function getUpgradeTo ($a_szApp, $a_szVersion)
{
	...
	$result = $g_oClient->doGetIsUpToDate($a_szApp, $a_szVersion, $a_boLatest);
	...
	$l_oR = $g_oClient->doGetUpgradeFromVersion($a_szApp, $a_szVersion, $l_aInfo);
