	...
	<div class="box mt20">
		<div class="box-body">
			...
			<ul class="nav nav-tabs mb10">
				<li class="active"><a href="#latest_tips" data-toggle="tab" aria-expanded="true"><?php echo lang('tips_latest_tips'); ?></a></li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade in" id="last_minute">
								...
								<tr>			
									...
									<td class="text-left">
										...
										<?php $league_name = $this->leagues_model->get_league_name_by_id($record->league_id); 
										 echo character_limiter($league_name ,9,'&#8230;')?>
						...
						<table id="events_table" class="table table-striped" role="grid">
							<thead class="bg-black">
								<tr>
									...
									<th class="pn"></th>
									<th class="pn"></th>
									<th class="pnn"><?php echo lang('tips_match_date'); ?></th>
									<th class="pnn"><?php echo lang('tips_match_time'); ?></th>
									<th class="pn"></th>
								</tr>
							</thead>				
							<tbody>
								...
								<?php endforeach;?>
									...
									<td>
										...
										<input type="hidden" name="home_team" id="home_team" value="<?php echo $record->home_team; ?>">
										<input type="hidden" name="away_team" id="away_team" value="<?php echo $record->away_team; ?>">
										<input type="submit" class="btn btn-lblue" value="<?php echo lang('tips_bet_now'); ?>">
										<?php echo form_close();?>
									</td>
				...
				<div class="tab-pane active fade in" id="latest_tips">
					...
					<div class="table-responsive">
						<table class='table table-striped'>
							...
							<tr>
								...
								<td class="pn">
									<a href="<?php echo base_url(); ?>tips/preview/<?php echo $record->id; ?>">
										<span class="text-blue mh5"><?php echo lang('tip_info');?></span>
									</a>
								</td>
								<td class="w30 pn text-left">	
									<img class="h30 mtm4" src="<?php echo base_url();?>uploads/teams/<?php e($this->teams_model->get_team_logo_by_name($rec->away_team,$record->league_id)); ?>"/>
								...
								<td class="text-center"><?php echo date('M d,Y', strtotime($record->match_date)); ?></td>
								<td><?php echo date('H:i T', strtotime($record->match_time)); ?></td>
	...
	<div class="box">
		<div class="box-body">
		<div class="table-responsive">
			<h4 class="head fs14 mb20"><?php echo lang('tips_top_5_ranking');?></h4>	

			<table class="table table-striped">
				<thead class="bg-black">
					<tr>
						<th class="pn w20">#</th>
						<th class="pn text-left"><?php echo lang('tips_tipster');?></th>
					...
					<tr>
						<?php if(isset($total_ranking) && is_array($total_ranking) && count($total_ranking)):
							...
							<td class="text-left">	
								...
								<img class="h30 mtm2" src="<?php echo base_url();?>uploads/countries/<?php echo $this->countries_model->get_country_flag_by_id($record->country);?>" alt="">	
