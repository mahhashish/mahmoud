	<div class="box no-shadow mb20">
		<div class="box-body">
				...
				<ul class="nav nav-tabs">
				  <li <?php if(!$pagination) echo 'class="active"' ?> ><a href="#stats" data-toggle="tab"><?php echo lang('tips_tab_stats');?></a></li>
				  <li><a href="#tips" data-toggle="tab"><?php echo lang('tips_tab_tips');?></a></li>
				  <?php if(isset($current_user) && $current_user->id == $user->id) :?>
				  <li <?php if($pagination) echo 'class="active"' ?> ><a href="#activities" data-toggle="tab"><?php echo lang('tips_frends_activities');?></a></li>
				  <?php endif;?>
				</ul>

				<div class="tab-content pn mt20">
					<div class="<?php if(!$pagination) echo 'active' ?>  tab-pane" id="stats">
							...
							<div class="col-sm-6">										
								...
								<ul class="nav nav-stacked">
									...
									<li><a href="<?php echo base_url();?>tips/index/sport_id-<?php echo $record->sport_id;?>">
										<img src="<?php echo base_url();?>uploads/sports/<?php echo $this->sports_model->get_sport_icon_by_id($record->sport_id); ?> " class="h30 mtm2"/>
								...
								<ul class="nav nav-stacked">
									...
									<li><a href="<?php echo base_url();?>tips/index/league_id-<?php echo $record->league_id;?>">
									   <?php $country = $this->leagues_model->get_league_country_by_id($record->league_id);?>
										<img src="<?php echo base_url();?>uploads/countries/<?php echo $this->countries_model->get_country_flag_by_id($country); ?> " class="h30 mr10 mtm2"/>
					...
					<div class="<?php if($pagination) echo 'active ' ?>tab-pane" id="activities">
							...
							<div class="table-responsive">
								<table class="table table-striped" role="grid">
									...
									<tbody>						
										...
										<tr>
											<td class="text-red" colspan="8"><?php echo lang('tips_no_friends'); ?></td>
										</tr>
