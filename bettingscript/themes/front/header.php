...
<head>
	...
	<meta charset="utf-8">
	<meta name="msvalidate.01" content="C906453753BE54B21AC1FE32AACAD1CA" />
	<title>
	<?php echo isset($page_title) ? "{$page_title} : " : ''; e(class_exists('Settings_lib') ? settings_item('site.title') : 'TipsterGala');?>
	</title>
	<meta name="description" content="Football match prediction community">
	<meta name="author" content="<?php e(isset($meta_author) ? $meta_author : ''); ?>">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta property="og:url"           content="https://tipstergala.com" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="TipsterGala" />
	<meta property="og:description"   content="Get further than just a win" />
	<meta property="og:image"         content="https://tipstergala.com/uploads/logo/tipstergalafb.png" />
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6&appId=425184174342137";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>

<script src="https://www.w3counter.com/tracker.js?id=102043"></script>
<!-- Site wrapper -->
<div class="wrapper">
          ...
          <div class="container-fluid">
			<div class="head-content">
				<div class="navbar-header">
				  ...
				  <span><span><img class="logoimage" src="https://tipstergala.com/uploads/logo/tipstergala.png"></span></a>
						...
						<li>
							...
							<div class="lang-holder">
							  <a href="#" class="topbar-menu-toggle" data-toggle="button">
								...
								{
								$language = $this->settings_lib->item('default_language');
								echo $language;
								} ?>.png">
							  </a>
							</div>
        ...
        <div class="container-fluid">
			...
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
				...
				<span><div class="fb-like" 
					data-href="https://tipstergala.com" 
